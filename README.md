...
## Data Access 📂
We have 3 datasets. For this project we only use 1st and 2nd datasets.
https://github.com/hoanmyha/Economic-Impacts-of-U.S.-Tax-Haven-States/tree/1f614070927dfb54be92e75290d16a60a19d423f/Dataset
...
- **Tax_Category** : High-level category of tax revenue (e.g., income, sales, excise, severance)

- **Tax_Code** : Specific tax classification code used in the source dataset

- **Amount**: Total tax revenue collected for the given state, year, quarter, and tax type (USD)
